...
export default function LiveSensorPage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-6">
    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm"><h3 className="font-semibold text-slate-900">Start in one terminal</h3><ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-6 text-slate-600"><li>Install Zeek once with <code className="rounded bg-slate-100 px-1.5 py-0.5">brew install zeek</code>.</li><li>Confirm your authorised interface with <code className="rounded bg-slate-100 px-1.5 py-0.5">networksetup -listallhardwareports</code>.</li><li>Run <code className="rounded bg-slate-100 px-1.5 py-0.5">WTH_ANALYST_PASSWORD=&apos;…&apos; bash deployment/scripts/start_live_demo.sh en0</code> from the project root.</li><li>Click Refresh, then open the detected source below.</li></ol><p className="mt-4 text-xs text-slate-500">Docker runs the app and adapter; Zeek stays on macOS because Docker Desktop cannot capture the Mac Wi-Fi interface. Exact commands and safety notes: <code>docs/demo/live-zeek-ingestion.md</code>.</p></section>
